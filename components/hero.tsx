...
export function Hero({ onCtaClick }: HeroProps) {
  return (
    <section className="relative h-[calc(100vh-4rem)] flex items-center bg-gradient-to-b from-[#0A1930] to-[#0D1B2E] overflow-hidden">
      ...
      <div className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-[#0A1930] via-[#0A1930]/80 to-transparent z-[3]" />
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full text-left p-4 bg-[#152238] border border-white/10 rounded-xl hover:border-[#00C8FF]/50 hover:-translate-y-1 transition-all group"
              >
                <div className="flex items-center justify-between">
                  <span className="text-[#00C8FF] font-semibold text-lg">Uncover sales opportunities</span>
                  <ArrowRight className="text-[#00C8FF] group-hover:translate-x-1 transition-transform" size={20} />
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[#00C8FF] font-semibold text-lg">Sharpen go-to-market</span>
                  <ArrowRight className="text-[#00C8FF] group-hover:translate-x-1 transition-transform" size={20} />
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[#00C8FF] font-semibold text-lg">Grow with confidence</span>
                  <ArrowRight className="text-[#00C8FF] group-hover:translate-x-1 transition-transform" size={20} />
                </div>
              </button>
            </div>
            ...
            <div className="pt-4 border-t border-white/10">
              <Button
                size="lg"
                className="bg-[#00C8FF] text-white hover:bg-[#0891B2] font-semibold text-base px-8 py-4 rounded-xl group transition-all"
